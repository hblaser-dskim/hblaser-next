            ...
            <section class="sub-section global-section">
                <div class="container">
                    ...
                    <div class="global-wrap">
                        <div class="img-box">
                            <img src="/img/onepixel/images/recruit_img.png" alt="채용공고 PC 이미지" class="hidden-xs">
                            <img src="/img/onepixel/images/m_recruit_img.png" alt="채용공고 MOBILE 이미지" class="visible-xs">
                        </div>
                    </div>
                </div>
            </section>
