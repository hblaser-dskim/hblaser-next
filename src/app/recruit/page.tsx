            ...
            <div dangerouslySetInnerHTML={{__html: `<section id="sub-hero" className="hero-05">
                ...
                <div className="hero-caption container">
                    <div className="caption-cell">
                        <h2 data-aos="fade-down" data-aos-duration="1200" data-aos-delay="200">채용공고</h2>
                        <p data-aos="fade-up" data-aos-duration="1200" data-aos-delay="500">한빛레이저의 채용공고입니다.</p>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    ...
                    <div className="global-wrap">
                        <div className="img-box">
                            <img src="/img/onepixel/images/recruit_img.png" alt="채용공고 PC 이미지" className="hidden-xs">
                            <img src="/img/onepixel/images/m_recruit_img.png" alt="채용공고 MOBILE 이미지" className="visible-xs">
                        </div>
                    </div>
                </div>
            </section>`}} />
